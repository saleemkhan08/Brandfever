...
public class CartAdapter extends FirebaseRecyclerAdapter<Products, CartListProductViewHolder>
{
    ...
    protected void populateViewHolder(final CartListProductViewHolder viewHolder, final Products model, int position)
    {
        ...
        viewHolder.mNoOfPieces.setText(String.valueOf(getSelectedSizeCount(model)));
        ...
        viewHolder.mToggleCart.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
    ...
    private int getSelectedSizeCount(Products model)
    {
        Map<String, Integer> sizes =  model.getSizesMap();
